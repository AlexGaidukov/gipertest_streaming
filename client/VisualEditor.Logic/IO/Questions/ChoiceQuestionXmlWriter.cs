...
{
    internal class ChoiceQuestionXmlWriter : QuestionXmlWriter
    {
        public ChoiceQuestionXmlWriter(Question question)
        {
        ...
        public override void WriteXml(XmlTextWriter xmlWriter)
        {
            ...
            xmlWriter.WriteAttributeString("type", "radio");
            ...
            if (question.ResponseVariants.Count != 0)
            {
                foreach (ResponseVariant rv in question.ResponseVariants)
                {
                  ...
                  //  Warehouse.Warehouse.Instance.CourseTree.CurrentNode = this.question;
