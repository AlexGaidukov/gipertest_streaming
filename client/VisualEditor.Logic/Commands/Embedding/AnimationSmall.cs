...
{
    internal class AnimationSmall : AbstractCommand
    {
        ...
        public AnimationSmall()
        {
            name = CommandNames.AnimationSmall;
            text = CommandTexts.AnimationSmall;
        ...
        public override void Execute(object @object)
        {
            ...
            using (var ad = new AnimationDialog())
            {
                ...
                if (ad.ShowDialog(EditorObserver.DialogOwner) == DialogResult.OK)
                {
                    ...
                    var destPath = Path.Combine(Warehouse.Warehouse.AbsoluteEditorFlashesDirectory, animationName);
                    ...
                    var animationNameWithoutExtension = Path.GetFileNameWithoutExtension(source);
                    source = source.Replace(animationNameWithoutExtension, animationName);
