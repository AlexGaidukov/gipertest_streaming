...
{
    internal class TableSmall : AbstractCommand
    {
        private const string operationCantBePerformedMessage = "Невозможно вставить рисунок в редактор.";

        public TableSmall()
        {
            name = CommandNames.TableSmall;
            text = CommandTexts.TableSmall;
        ...
        public override void Execute(object @object)
        {
            ...
            // POSTPONE: Продумать логику изменения существующей таблицы.
