...
{
    internal class HintOutdent : AbstractCommand
    {
        private const string operationCantBePerformedMessage = "Невозможно выполнить операцию. Попробуйте повтротить снова.";

        public HintOutdent()
        {
            name = CommandNames.HintOutdent;
            text = CommandTexts.HintOutdent;
            image = Properties.Resources.Outdent;
        }
        ...
        public override void Execute(object @object)
        {
            ...
            try
            {
                EditorObserver.ActiveEditor.Outdent();
            }
