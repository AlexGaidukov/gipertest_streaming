...
{
    internal class HintPictureSmall : AbstractCommand
    {
        ...
        public HintPictureSmall()
        {
            name = CommandNames.HintPictureSmall;
            text = CommandTexts.HintPictureSmall;
        ...
        public override void Execute(object @object)
        {
            ...
            using (var pd = new PictureDialog())
            {
                ...
                if (pd.ShowDialog(EditorObserver.DialogOwner) == DialogResult.OK)
                {
                    ...
                    var destPath = Path.Combine(Warehouse.Warehouse.AbsoluteEditorImagesDirectory, Path.GetFileName(source));
