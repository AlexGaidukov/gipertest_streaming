...
{
    internal class HintJustifyFull : AbstractCommand
    {
        private const string operationCantBePerformedMessage = "Невозможно выполнить операцию. Попробуйте повтротить снова.";

        public HintJustifyFull()
        {
            name = CommandNames.HintJustifyFull;
            text = CommandTexts.HintJustifyFull;
            image = Properties.Resources.JustifyFull;
        }
        ...
        public override void Execute(object @object)
        {
            ...
            try
            {
                EditorObserver.ActiveEditor.JustifyFull();
            }
