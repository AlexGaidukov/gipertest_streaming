...
namespace VisualEditor.Logic.Commands.HtmlEditing
{
    internal class FontName : AbstractCommand
    {
        ...
        public override void Execute(object @object)
        {
            ...
            try
            {
                EditorObserver.ActiveEditor.SetFontName(FontNameComboBox.FontName);
