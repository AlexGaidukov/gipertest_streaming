...
namespace VisualEditor.Logic.Commands.HtmlEditing
{
    internal class FontSize : AbstractCommand
    {
        ...
        public override void Execute(object @object)
        {
            ...
            try
            {
                EditorObserver.ActiveEditor.SetFontSize(FontSizeComboBox.FontSize);
