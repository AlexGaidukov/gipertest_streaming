...
{
    internal class HorizontalRule : AbstractCommand
    {
        private const string operationCantBePerformedMessage = "Невозможно выполнить операцию. Попробуйте повтротить снова.";

        public HorizontalRule()
        {
            name = CommandNames.HorizontalRule;
            text = CommandTexts.HorizontalRule;
            image = Properties.Resources.HorizontalRule;
        }
        ...
        public override void Execute(object @object)
        {
            ...
            try
            {
                EditorObserver.ActiveEditor.InsertHorizontalRule();
