...
{
    internal class AddMultichoiceQuestionSmall : AbstractCommand
    {
        public AddMultichoiceQuestionSmall()
        {
            name = CommandNames.AddMultichoiceQuestionSmall;
            text = CommandTexts.AddMultichoiceQuestionSmall;
