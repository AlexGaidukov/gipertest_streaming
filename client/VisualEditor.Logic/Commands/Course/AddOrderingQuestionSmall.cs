...
{
    internal class AddOrderingQuestionSmall : AbstractCommand
    {
        public AddOrderingQuestionSmall()
        {
            name = CommandNames.AddOrderingQuestionSmall;
            text = CommandTexts.AddOrderingQuestionSmall;
