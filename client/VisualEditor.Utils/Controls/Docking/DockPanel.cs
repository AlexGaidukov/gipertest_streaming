...
namespace VisualEditor.Utils.Controls.Docking
{
    ...
    [ToolboxBitmap(typeof(resfinder), "VisualEditor.Utils.Controls.Docking.DockPanel.bmp")]
    ...
    public partial class DockPanel : Panel
    {
        ...
        public DockPanel()
        {
            m_focusManager = new DockPanel.FocusManagerImpl(this);
            ...
            m_autoHideWindow = new DockPanel.AutoHideWindowControl(this)
                                   {
                                       Visible = false
                                   };
...
namespace VisualEditor.Utils.Docking
{
