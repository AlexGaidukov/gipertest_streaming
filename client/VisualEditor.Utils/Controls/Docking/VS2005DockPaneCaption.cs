...
namespace VisualEditor.Utils.Controls.Docking
{
    internal class VS2005DockPaneCaption : DockPaneCaptionBase
    {
        private sealed class InertButton : InertButtonBase
        {
            ...
            private VS2005DockPaneCaption DockPaneCaption { get; set; }
        ...
        private void DrawCaption(Graphics g)
        {
            ...
            {
                using (var brush = new LinearGradientBrush(ClientRectangle, ActiveBackColorGradientBegin, ActiveBackColorGradientEnd, LinearGradientMode.Vertical))
                {
