...
namespace VisualEditor.Utils.Controls.Ribbon
{
    ...
    public sealed class RibbonButtonList : RibbonItem, IContainsSelectableRibbonItems, IScrollableRibbonItem, IContainsRibbonComponents
    {
        ...
        public void ShowDropDown()
        {
            ...
            _dropDown = new RibbonDropDown(this, DropDownItems, Owner) {ShowSizingGrip = true};
        ...
        public override void SetBounds(Rectangle bounds)
        {
            ...
            _buttonDropDownBounds = cbtns == 2 ? Rectangle.Empty : Rectangle.FromLTRB(_buttonDownBounds.Left, _buttonDownBounds.Bottom,
