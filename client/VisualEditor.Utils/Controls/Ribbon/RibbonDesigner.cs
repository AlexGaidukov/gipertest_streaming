...
namespace VisualEditor.Utils.Controls.Ribbon
{
    public class RibbonDesigner : ControlDesigner
    {
        ...
        /// </summary>
        public Controls.Ribbon.Ribbon Ribbon
        {
            get { return Control as Controls.Ribbon.Ribbon; }
        } 
        ...
        public virtual void CreateItem(Controls.Ribbon.Ribbon ribbon, RibbonItemCollection collection, Type t)
        {
        ...
        {
            Controls.Ribbon.Ribbon r = Control as Controls.Ribbon.Ribbon;
                    ...
                    if (Ribbon.ActiveTab.TabContentBounds.Contains(x, y))
                    {
                        ...
                        if (hittedPanel != null)
                        {
                            ...
                            if (hittedItem != null && hittedItem is IContainsSelectableRibbonItems)
                            {
                                ...
                                SelectedElement = hittedSubItem ?? hittedItem;
                            }
        ...
        public override void Initialize(IComponent component)
        {
            ...
            BehaviorService.Adorners.AddRange(new [] { quickAccessAdorner, orbAdorner, tabAdorner });
