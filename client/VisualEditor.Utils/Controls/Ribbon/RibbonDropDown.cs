...
namespace VisualEditor.Utils.Controls.Ribbon
{
    ...
    public class RibbonDropDown : RibbonPopup
    {
        ...
        private Controls.Ribbon.Ribbon _ownerRibbon;
        ...
        /// </summary>
        public Controls.Ribbon.Ribbon OwnerRibbon
        {
        ...
        private void UpdateItemsBounds()
        {
            ...
            _sizingGripBounds = ShowSizingGrip ? Rectangle.FromLTRB(
                                                     ClientSize.Width - SizingGripHeight, ClientSize.Height - SizingGripHeight,
                                                     ClientSize.Width, ClientSize.Height) : Rectangle.Empty;
        }
