...
namespace VisualEditor.Utils.Controls.Ribbon
{
    ...
    /// </summary>
    public class RibbonSensor : IDisposable
    {
        #region Fields

        private Controls.Ribbon.Ribbon _ribbon;
        ...
        /// </summary>
        public bool SenseOnlyItems { get; set; }
        ...
        private bool MouseMoveTabScroll(int x, int y)
        {
            ...
            if (!(Control is Controls.Ribbon.Ribbon))
            {
                return false;
            }
        ...
        public void SenseMouseDown(MouseEventArgs e)
        {
            ...
            if (hittedPanel != null && hittedPanel.Collapsed && Control is Controls.Ribbon.Ribbon)
            {
                return;
            }
